...
The login page for Admin is put seperately at /admin.php
            username : admin
            password : admin
...
Please kindly login as admin and create employees and hrs before logging in as employee and hr because the database and tables where created at admin end.  
...
the payscale is for minutes as you can not observe a valid change if it is for hours and the total active time is also in minutesfor the same reason;
